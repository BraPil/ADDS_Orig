...
$sourceDir = "S:\Workgroups\APC Power Delivery\Division Mapping Test\Test Distribution\Adds"
...
$sourceDir = "S:\Workgroups\APC Power Delivery\Division Mapping Test\Test Distribution\CommonW10"
robocopy $sourceDir $targetDir /lev:0 /XO /SEC /np /nfl

$sourceDir = "S:\Workgroups\APC Power Delivery\Division Mapping Test\Test Distribution\DosLib"
$targetDir = "C:\Div_Map\DosLib"
robocopy $sourceDir $targetDir /lev:0 /XO /SEC /np /nfl

$sourceDir = "S:\Workgroups\APC Power Delivery\Division Mapping Test\Test Distribution\Icon_Collection"
$targetDir = "C:\Div_Map\Icon_Collection"
robocopy $sourceDir $targetDir /S /XO /SEC /np /nfl

$sourceDir = "S:\Workgroups\APC Power Delivery\Division Mapping Test\Test Distribution\LookUpTable"
$targetDir = "C:\Div_Map\LookUpTable"
robocopy $sourceDir $targetDir /S /XO /SEC /np /nfl

$sourceDir = "S:\Workgroups\APC Power Delivery\Division Mapping Test\Test Distribution\Utils"
...
$key = "HKCU:\SOFTWARE\Autodesk\AutoCAD\R20.1\ACAD-F002:409\Profiles\ADDS_T"
$profileExists = Test-Path $key
If($profileExists -eq $True)
{
	Start-Process -FilePath "C:\Program Files\Autodesk\AutoCAD 2016\acad.exe" -ArgumentList "/nologo /p ADDS_T"
}
else
{
