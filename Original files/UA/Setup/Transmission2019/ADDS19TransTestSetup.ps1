...
$bkey = (Get-ItemProperty "HKLM:\SOFTWARE\Autodesk\AutoCAD\R23.1\ACAD-3002:409").ProductID
if($bkey -eq "3002")
	{
	...
	{
		[System.Windows.Forms.MessageBox]::Show(“AutoCAD Map 3D 2019 has NOT been installed.", "ADDS", 
			[System.Windows.Forms.MessageBoxButtons]::OK, [System.Windows.Forms.MessageBoxIcon]::Information)::OK
		#	MH  shortcut to install AutoCAD Map3 2016
		Target:	\\ecsapps\apps\Autodesk\2019\Map3D\Deployments\Img\Setup.exe /qb /I \\ecsapps\apps\Autodesk\2019\Map3D\Deployments\Img\Silent.ini /Trial /language en-us
		#Start In:	\\ecsapps\apps\Autodesk\2019\Map3D\Deployments\Img
