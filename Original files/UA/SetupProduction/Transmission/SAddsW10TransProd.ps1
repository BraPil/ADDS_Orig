...
$sourceFile = "S:\Workgroups\APC Power Delivery\Division Mapping Test\TransmissionProduction\Setup\div_map.ini"
...
$sourceDir = "S:\Workgroups\APC Power Delivery\Division Mapping Test\TransmissionProduction\Setup\Adds"
...
$sourceDir = "S:\Workgroups\APC Power Delivery\Division Mapping Test\TransmissionProduction\Setup\Common"
$targetDir = "C:\Div_Map\Common"
robocopy $sourceDir $targetDir /lev:0 /XO /SEC /np /nfl			# lev:0~Copies commom subdirectory only

$sourceDir = "S:\Workgroups\APC Power Delivery\Division Mapping Test\TransmissionProduction\Setup\CommonW10"
robocopy $sourceDir $targetDir /lev:0 /XO /SEC /np /nfl

$sourceDir = "S:\Workgroups\APC Power Delivery\Division Mapping Test\TransmissionProduction\Setup\DosLib"
$targetDir = "C:\Div_Map\DosLib"
robocopy $sourceDir $targetDir /lev:0 /XO /SEC /np /nfl

$sourceDir = "S:\Workgroups\APC Power Delivery\Division Mapping Test\TransmissionProduction\Setup\Icon_Collection"
$targetDir = "C:\Div_Map\Icon_Collection"
robocopy $sourceDir $targetDir /S /XO /SEC /np /nfl

$sourceDir = "S:\Workgroups\APC Power Delivery\Division Mapping Test\TransmissionProduction\Setup\LookUpTable"
$targetDir = "C:\Div_Map\LookUpTable"
robocopy $sourceDir $targetDir /S /XO /SEC /np /nfl

$sourceDir = "S:\Workgroups\APC Power Delivery\Division Mapping Test\TransmissionProduction\Setup\Utils"
